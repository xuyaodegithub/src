  ...
  <div class="distribute-leaflets">             <!-- -----派单-  大块--- -->
    <div class="main-block-top">
      <div class="question-block">
        ...
        <div class="question top5">
          <div class="question-left"><span class="typeface">增值服务类别</span></div>
          <div class="question-right">
            <el-input type="text" v-model="startData" size="small" class="input-style"></el-input>
          </div>
        </div>
        <div class="question top5">
      ...
      <div class="question-block left10">
        ...
        <div class="question top5">
          <div class="question-left"><span class="typeface">增值服务余额(元)</span></div>
          <div class="question-right">
            <el-input type="text" v-model="pre_3" size="small" class="input-style"></el-input>
          </div>
        </div>
        <div class="question top5">
          <div class="question-left"><span class="typeface">是否服务承诺区域</span></div>
          <div class="question-right">
            <el-input type="text" v-model="pre_5" size="small" class="input-style"></el-input>
          </div>
        </div>
      </div>
      <div class="question-block left10">
      ...
      <div class="question top5">
        ...
        <div class="question-right">
          <el-select v-model="knowledgeValue" placeholder="请选择">
            <el-option
              v-for="(item,key) in queryInternetActivityByCity"
              :key="key"
    ...
    <div class="main-block-bottom">
      <el-button @click="turnSendTicketActions('1')">工单派发</el-button>
    </div>
  </div>
</template>

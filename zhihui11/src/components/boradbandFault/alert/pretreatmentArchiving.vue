<template>
  <div class="demo incomingHistory">            <!-- 预处理归档 -->
    <div class="popover-head">
      <span class="title">预处理归档</span>
    ...
    <div class="popover-main">
      <div class="option">
        ...
        <span class="wordtype">
          尊敬的客户，您可拨打10000按4号键进行宽带快速报修，或您可使用手机QQ点击“联系人”，
          “公众号”。查找“中国电信”公众号-找到并点击“宽带排障”进行故障快速报修，并可通过“在线帮助-在线客服”，快速为您接入QQ人工服务。
        </span>
      </div>

      <div class="option1">
        <el-button type="primary" class="buttonclick" @click="popoverAlert()">确定</el-button>
      </div>
    </div>
  </div>
</template>

<template>
  <div class="history-red-packet-back">            <!-- -----历史红包返还 块-----  -->
    ...
    <div class="miscel-block-bottom">      <!--历史红包返还 表格 -->
      <div class="table-head">
        <div class="item-list-big">交易时间</div>
        <div class="item-list">余额存入</div>
        <div class="item-list">翼支付账户</div>
        <div class="item-list">充值状态</div>
        <div class="item-list">原因</div>
      </div>
      <div class="table-body">
        <div class="table-list" v-for="item in getEpayChargeBillRecord">
          <div class="item-list-big">{{item.stateDate}}</div>
          <div class="item-list">{{item.returnAmount}}</div>
          <div class="item-list">{{item.returnAccountNo}}</div>
          <div class="item-list">{{item.returnState}}</div>
          <div class="item-list"> {{item.returnStateDesc}}</div>
        </div>
      </div>
  ...
  export default {
    data() {
      return {
        ...
        pre_same_contract_number:'',  //历史合同号
...
//      this.pre_same_contract_number=this.personMessage.billAccountNum;
    ...
    computed:{
      ...mapGetters([
        'assetVOS','personMessage','businessCallNumber','queryBillReturnDetail','getEpayChargeBillRecord'
      ]),
    },
    methods: {
      ...mapActions([

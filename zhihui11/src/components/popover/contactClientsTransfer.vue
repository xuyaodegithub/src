<template>
  <div class="demo">
    <div class="popover-head">
      <span class="title">联系客户经理</span><span class="small-title"></span><i v-on:click="popoverAlert()" class="el-icon-close"></i>
    </div>
    ...
    <span class="popover-btn" @click="turnOld()">转接</span>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      turnOld(){
          this.popoverAlert();
        document.getElementById("oldWindow").contentWindow.dotransivrCustomerManager();
        document.getElementById("oldWindow").contentWindow.sendRemindSmsToManager();
      },
      ...mapActions([
        'popoverAlert'
      ]),

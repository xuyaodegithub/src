<template>
  <div class="demo incomingHistory" :class="{miniHeight: miniHeightStatus}">
    <div class="popover-head">
      <span class="title" v-html="remindMessage()"></span>
  ...
  export default {
    ...
    computed:{
      ...
      word(){
        ...
        if(cardtype =='军官证'|| cardtype=='警官证'|| cardtype=='外国人永久居留身份证'){
          testMessage1 = "<td width='80%' align='left' border='0' cellspacing='0' cellpadding='10'  >“外国人永久居留身份证”、“军官证”、“警官证”三类证件，在10000可进行<font color=red>“业务查询”</font>、<font color=red>“停复机”</font>业务办理，其余业务办理请引导客户通过自助方式或至电信自有营业厅</td>"
          if(cardtype=='军官证'){
            testMessage2 = "<tr BGCOLOR='#F2F2F2'><td align='center' width='20%'>话术指引：</td><td width='80%' align='left' border='0' cellspacing='3' cellpadding='3'>" +
              "您好，您的证件类型为“<font color=red>" +cardtype +"</font>”，根据工信部最新要求，若您要办理电信业务，请携带军官证（或武装警察证/士官证）和军人身份证前往电信<a target='_blank' href='http://134.96.108.136:8111/logingetDocHtml.do?loginId="
              +id+"&cityId="+searchCity+"&countyId="+searchCountyCode+"&visitType=1&docid=68080&callNum="+this.callNumber+"&busiNum="+this.businessCallNumber+"'>自有营业厅</a>办理。</td></tr>";
          }else if(cardtype=='警官证'){
            testMessage2 = "<tr BGCOLOR='#F2F2F2'><td align='center' width='20%'>话术指引：</td><td width='80%' align='left' border='0' cellspacing='3' cellpadding='3'>" +
              "您好，您的证件类型为“<font color=red>" +cardtype +"</font>”，根据工信部最新要求，若您要办理电信业务，请携带武装警察证（或军官证/士官证）和武装警察身份证前往电信<a target='_blank' href='http://134.96.108.136:8111/logingetDocHtml.do?loginId="
              +id+"&cityId="+searchCity+"&countyId="+searchCountyCode+"&visitType=1&docid=68080&callNum="+this.callNumber+"&busiNum="+this.businessCallNumber+"'>自有营业厅</a>办理。</td></tr>";
          }else if(cardtype=='外国人永久居留身份证'){
            testMessage2 = "<tr BGCOLOR='#F2F2F2'><td align='center' width='20%'>话术指引：</td><td width='80%' align='left' border='0' cellspacing='3' cellpadding='3'>" +
              "您好，您的证件类型为“<font color=red>" +cardtype +"</font>”，根据工信部最新要求，若您要办理电信业务，请带上您的"+cardtype+"到电信<a target='_blank' href='http://134.96.108.136:8111/logingetDocHtml.do?loginId="
              +id+"&cityId="+searchCity+"&countyId="+searchCountyCode+"&visitType=1&docid=68080&callNum="+this.callNumber+"&busiNum="+this.businessCallNumber+"'>自有营业厅</a>办理。</td></tr>";
          }
        ...
        let tableHtml = "<div id='realnameMsgDiv'><table BORDERCOLOR='#15428b'  width='99%' border='0'>"+
    ...
    methods: {
      ...
      remindMessage(){
        let cardtype = this.personMessage.accountIdType
        if(cardtype=='军官证'||cardtype=='警官证'||cardtype=='外国人永久居留身份证'){
          return '<font color=red>'+cardtype+'-信息提醒</font>';
        }else if(cardtype=='户口簿'){
          return '<font color=red>'+cardtype+'-个人信息修改提醒</font>';
        }else if(cardtype=='居民临时身份证'){
          return '<font color=red>'+cardtype+'-二次业务办理指引</font>';
        }
      },
      changeSmall(){
